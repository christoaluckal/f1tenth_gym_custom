...
for r in ratios:
    ...
    exp3 = "python3 test_sb.py --config 2 --car_idx 3 --base 0 --retain 0.8" + str(r[1]) + exp_str +" --exp 3 --verbose 1"
    exp5 = "python3 test_sb.py --config 3 --car_idx 5 --base 0 --retain 0.6" + str(r[2]) + exp_str +" --exp 5 --verbose 1"
