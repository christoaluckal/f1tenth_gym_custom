...
exp4 = "python3 test_sb.py --config 2 --car_idx 4 --base 1 --retain 1" + exp_str +" --exp 4 --verbose 0"
exp5 = "python3 test_sb.py --config 3 --car_idx 5 --base 0 --retain 0.6" + exp_str +" --exp 5 --verbose 1"
exp6 = "python3 test_sb.py --config 3 --car_idx 6 --base 1 --retain 1" + exp_str +" --exp 6 --verbose 0"
